...
public class Packager {
    ...
    public static void BuildAssetResource(BuildTarget target) {
        if (Directory.Exists(QUtil.DataPath)) {
            Directory.Delete(QUtil.DataPath, true);
        }
        ...
        string streamDir = Application.dataPath + "/" + QAppConst.LuaTempDir;
    ...
    static void HandleLuaBundle() {
        ...
        for (int i = 0; i < dirs.Length; i++) {
            ...
            name = "lua/lua_" + name.ToLower() + QAppConst.ExtName;

            string path = "Assets" + dirs[i].Replace(Application.dataPath, "");
            AddBuildMap(name, "*.bytes", path);
        }
        AddBuildMap("lua/lua" + QAppConst.ExtName, "*.bytes", "Assets/" + QAppConst.LuaTempDir);
