...
namespace QFramework {
	...
	public class AlphaLTDescr
	{
		...
		public AlphaLTRect AlphaLTRect;
		public Vector3 from;
		public Vector3 to;
		public Vector3 diff;
		...
		public AlphaAlphaLTBezierPath path;
		public AlphaLTSpline spline;
		public AlphaTweenAction type;
		public AlphaTweenType tweenType;
		public AnimationCurve animationCurve;
		public AlphaTweenType loopType;
		...
		[System.Obsolete("Use 'AlphaTween.cancel( id )' instead")]
		public AlphaLTDescr cancel(GameObject gameObject)
		{
			// Debug.Log("canceling id:"+this._id+" this.uniqueId:"+this.uniqueId+" go:"+this.trans.gameObject);
			if (gameObject == this.trans.gameObject)
				PTAlphaTween.removeTween((int)this._id, this.uniqueId);
			return this;
		}

		/*[System.Obsolete("Use 'AlphaTween.cancel( id )' instead")]
    public AlphaLTDescr cancel(){
        // Debug.Log("canceling id:"+this._id+" this.uniqueId:"+this.uniqueId+" go:"+this.trans.gameObject);
        AlphaTween.removeTween((int)this._id);
        return this;
    }*/
		...
		public void reset()
		{
			...
			this.tweenType = AlphaTweenType.linear;
			this.loopType = AlphaTweenType.once;
			this.loopCount = 0;
		...
		public void init()
		{
			...
			switch (this.type)
			{
				case AlphaTweenAction.MOVE:
				case AlphaTweenAction.MOVE_TO_TRANSFORM:
					this.from = trans.position; break;
				case AlphaTweenAction.MOVE_X:
					this.from.x = trans.position.x; break;
				case AlphaTweenAction.MOVE_Y:
					this.from.x = trans.position.y; break;
				case AlphaTweenAction.MOVE_Z:
					this.from.x = trans.position.z; break;
				case AlphaTweenAction.MOVE_LOCAL_X:
					this.from.x = trans.localPosition.x; break;
				case AlphaTweenAction.MOVE_LOCAL_Y:
					this.from.x = trans.localPosition.y; break;
				case AlphaTweenAction.MOVE_LOCAL_Z:
					this.from.x = trans.localPosition.z; break;
				case AlphaTweenAction.SCALE_X:
					this.from.x = trans.localScale.x; break;
				case AlphaTweenAction.SCALE_Y:
					this.from.x = trans.localScale.y; break;
				case AlphaTweenAction.SCALE_Z:
					this.from.x = trans.localScale.z; break;
				case AlphaTweenAction.ALPHA:
					...
					break;
					#endif
				case AlphaTweenAction.MOVE_LOCAL:
					this.from = trans.localPosition; break;
				case AlphaTweenAction.MOVE_CURVED:
				case AlphaTweenAction.MOVE_CURVED_LOCAL:
				case AlphaTweenAction.MOVE_SPLINE:
				case AlphaTweenAction.MOVE_SPLINE_LOCAL:
					this.from.x = 0; break;
				case AlphaTweenAction.ROTATE:
					this.from = trans.eulerAngles;
					this.to = new Vector3(PTAlphaTween.closestRot(this.from.x, this.to.x), PTAlphaTween.closestRot(this.from.y, this.to.y), PTAlphaTween.closestRot(this.from.z, this.to.z));
					break;
				case AlphaTweenAction.ROTATE_X:
					this.from.x = trans.eulerAngles.x;
					this.to.x = PTAlphaTween.closestRot(this.from.x, this.to.x);
					break;
				case AlphaTweenAction.ROTATE_Y:
					this.from.x = trans.eulerAngles.y;
					this.to.x = PTAlphaTween.closestRot(this.from.x, this.to.x);
					break;
				case AlphaTweenAction.ROTATE_Z:
					this.from.x = trans.eulerAngles.z;
					this.to.x = PTAlphaTween.closestRot(this.from.x, this.to.x);
					break;
				case AlphaTweenAction.ROTATE_AROUND:
					this.lastVal = 0.0f; // optional["last"]
					this.from.x = 0.0f;
					this.origRotation = trans.rotation; // optional["origRotation"
					break;
				case AlphaTweenAction.ROTATE_AROUND_LOCAL:
					this.lastVal = 0.0f; // optional["last"]
					this.from.x = 0.0f;
					this.origRotation = trans.localRotation; // optional["origRotation"
					break;
				case AlphaTweenAction.ROTATE_LOCAL:
					this.from = trans.localEulerAngles;
					this.to = new Vector3(PTAlphaTween.closestRot(this.from.x, this.to.x), PTAlphaTween.closestRot(this.from.y, this.to.y), PTAlphaTween.closestRot(this.from.z, this.to.z));
					break;
				case AlphaTweenAction.SCALE:
					this.from = trans.localScale; break;
				case AlphaTweenAction.GUI_MOVE:
					this.from = new Vector3(this.AlphaLTRect.rect.x, this.AlphaLTRect.rect.y, 0); break;
				case AlphaTweenAction.GUI_MOVE_MARGIN:
					this.from = new Vector2(this.AlphaLTRect.margin.x, this.AlphaLTRect.margin.y); break;
				case AlphaTweenAction.GUI_SCALE:
					this.from = new Vector3(this.AlphaLTRect.rect.width, this.AlphaLTRect.rect.height, 0); break;
				case AlphaTweenAction.GUI_ALPHA:
					this.from.x = this.AlphaLTRect.alpha; break;
				case AlphaTweenAction.GUI_ROTATE:
					if (this.AlphaLTRect.rotateEnabled == false)
					{
						this.AlphaLTRect.rotateEnabled = true;
						this.AlphaLTRect.resetForRotation();
					}

					this.from.x = this.AlphaLTRect.rotation; break;
				case AlphaTweenAction.ALPHA_VERTEX:
					this.from.x = trans.GetComponent<MeshFilter>().mesh.colors32[0].a;
					break;
				case AlphaTweenAction.CALLBACK:
					break;
				case AlphaTweenAction.CALLBACK_COLOR:
					this.diff = new Vector3(1.0f, 0.0f, 0.0f);
					break;
				case AlphaTweenAction.COLOR:
					#if UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2
					if(trans.gameObject.renderer){
		...
		public AlphaLTDescr setFromColor(Color col)
		{
    ...
    * 
    * @method pause
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public AlphaLTDescr pause()
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public AlphaLTDescr resume()
		{
			this.direction = this.directionLast;
			return this;
		}

		public AlphaLTDescr setAxis(Vector3 axis)
		{
			this.axis = axis;
			return this;
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setDelay( 1.5f );
    */
		public AlphaLTDescr setDelay(float delay)
		{
    ...
    * <ul><li><a href="AlphaTweenType.html">List of all the ease types</a>.</li>
    ...
    * 
    * @method setEase
    * @param {AlphaTweenType} easeType:AlphaTweenType the easing type to use
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setEase( AlphaTweenType.easeInBounce );
    */
		public AlphaLTDescr setEase(AlphaTweenType easeType)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setEase( AlphaTweenType.easeOutBack ).setOvershoot(2f);
    */
		public AlphaLTDescr setOvershoot(float overshoot)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setEase( AlphaTweenType.easeOutElastic ).setPeriod(0.3f);
    */
		public AlphaLTDescr setPeriod(float period)
		{
			this.period = period;
			return this;
		}
    ...
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setEase( AlphaTweenType.easeInBounce );
    */
		public AlphaLTDescr setEase(AnimationCurve easeCurve)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaLTDescr descr = AlphaTween.move( cube, Vector3.up, new Vector3(1f,3f,0f), 1.0f ).setEase( AlphaTweenType.easeInOutBounce );<br>
    * // Later your want to change your destination or your destiation is constantly moving<br>
		...
		*/
		public AlphaLTDescr setTo(Vector3 to)
		{
		...
		public AlphaLTDescr setTo(Transform to)
		{
			this.toTrans = to;
			return this;
		}

		public AlphaLTDescr setFrom(Vector3 from)
		{
			if (this.trans)
				this.init();
			this.from = from;
		...
		public AlphaLTDescr setFrom(float from)
		{
			return setFrom(new Vector3(from, 0f, 0f));
		}

		public AlphaLTDescr setDiff(Vector3 diff)
		{
			this.diff = diff;
			return this;
		}

		public AlphaLTDescr setHasInitialized(bool has)
		{
			this.hasInitiliazed = has;
			return this;
		}

		public AlphaLTDescr setId(uint id)
		{
			this._id = id;
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * int tweenId = AlphaTween.moveX(gameObject, 5f, 2.0f ).id;<br>
    * // Later<br>
		* AlphaLTDescr descr = description( tweenId );<br>
		* descr.setTime( 1f );<br>
		*/
		public AlphaLTDescr setTime(float time)
		{
			this.time = time;
			return this;
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setRepeat( 10 ).setLoopPingPong();
    */
		public AlphaLTDescr setRepeat(int repeat)
		{
			this.loopCount = repeat;
			if ((repeat > 1 && this.loopType == AlphaTweenType.once) || (repeat < 0 && this.loopType == AlphaTweenType.once))
			{
				this.loopType = AlphaTweenType.clamp;
			}
			if (this.type == AlphaTweenAction.CALLBACK || this.type == AlphaTweenAction.CALLBACK_COLOR)
			{
		...
		public AlphaLTDescr setLoopType(AlphaTweenType loopType)
		{
			this.loopType = loopType;
			return this;
		}

		public AlphaLTDescr setUseEstimatedTime(bool useEstimatedTime)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setRepeat( 2 ).setIgnoreTimeScale( true );
    */
		public AlphaLTDescr setIgnoreTimeScale(bool useUnScaledTime)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setRepeat( 2 ).setUseFrames( true );
    */
		public AlphaLTDescr setUseFrames(bool useFrames)
		{
			this.useFrames = useFrames;
			return this;
		}

		public AlphaLTDescr setUseManualTime(bool useManualTime)
		{
			this.useManualTime = useManualTime;
			return this;
		}

		public AlphaLTDescr setLoopCount(int loopCount)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setLoopOnce();
    */
		public AlphaLTDescr setLoopOnce() { this.loopType = AlphaTweenType.once; return this; }
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setLoopClamp( 2 );
    */
		public AlphaLTDescr setLoopClamp()
		{
			this.loopType = AlphaTweenType.clamp;
			if (this.loopCount == 0)
				this.loopCount = -1;
		...
		public AlphaLTDescr setLoopClamp(int loops)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setLoopPingPong( 2 );
    */
		public AlphaLTDescr setLoopPingPong()
		{
			this.loopType = AlphaTweenType.pingPong;
			if (this.loopCount == 0)
				this.loopCount = -1;
			return this;
		}
		public AlphaLTDescr setLoopPingPong(int loops)
		{
			this.loopType = AlphaTweenType.pingPong;
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnComplete( tweenFinished );
    */
		public AlphaLTDescr setOnComplete(Action onComplete)
		{
    ...
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnComplete( tweenFinished );
    */
		public AlphaLTDescr setOnComplete(Action<object> onComplete)
		{
			this.onCompleteObject = onComplete;
			return this;
		}
		public AlphaLTDescr setOnComplete(Action<object> onComplete, object onCompleteParam)
		{
			this.onCompleteObject = onComplete;
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.delayedCall(1.5f, enterMiniGameStart).setOnCompleteParam( new object[]{""+5} );<br><br>
    * void enterMiniGameStart( object val ){<br>
    * &nbsp;object[] arr = (object [])val;<br>
    * &nbsp;int lvl = int.Parse((string)arr[0]);<br>
    * }<br>
    */
		public AlphaLTDescr setOnCompleteParam(object onCompleteParam)
		{
			this.onCompleteParam = onCompleteParam;
			return this;
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnUpdate( tweenMoved );<br>
    * <br>
    * void tweenMoved( float val ){ }<br>
    */
		public AlphaLTDescr setOnUpdate(Action<float> onUpdate)
		{
			this.onUpdateFloat = onUpdate;
			this.hasUpdateCallback = true;
			return this;
		}
		public AlphaLTDescr setOnUpdateRatio(Action<float, float> onUpdate)
		{
		...
		public AlphaLTDescr setOnUpdateObject(Action<float, object> onUpdate)
		{
			this.onUpdateFloatObject = onUpdate;
			this.hasUpdateCallback = true;
			return this;
		}
		public AlphaLTDescr setOnUpdateVector2(Action<Vector2> onUpdate)
		{
			this.onUpdateVector2 = onUpdate;
			this.hasUpdateCallback = true;
			return this;
		}
		public AlphaLTDescr setOnUpdateVector3(Action<Vector3> onUpdate)
		{
			this.onUpdateVector3 = onUpdate;
			this.hasUpdateCallback = true;
			return this;
		}
		public AlphaLTDescr setOnUpdateColor(Action<Color> onUpdate)
		{
		...
		public AlphaLTDescr setOnUpdate(Action<Color> onUpdate)
		{
			this.onUpdateColor = onUpdate;
			this.hasUpdateCallback = true;
			return this;
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnUpdate( tweenMoved ).setOnUpdateParam( myObject );<br>
    * <br>
    * void tweenMoved( float val, object obj ){ }<br>
    */
		public AlphaLTDescr setOnUpdate(Action<float, object> onUpdate, object onUpdateParam = null)
		{
			this.onUpdateFloatObject = onUpdate;
			this.hasUpdateCallback = true;
		...
		public AlphaLTDescr setOnUpdate(Action<Vector3, object> onUpdate, object onUpdateParam = null)
		{
		...
		public AlphaLTDescr setOnUpdate(Action<Vector2> onUpdate, object onUpdateParam = null)
		{
			this.onUpdateVector2 = onUpdate;
			this.hasUpdateCallback = true;
			if (onUpdateParam != null)
    ...
    */
		public AlphaLTDescr setOnUpdate(Action<Vector3> onUpdate, object onUpdateParam = null)
		{
			this.onUpdateVector3 = onUpdate;
			this.hasUpdateCallback = true;
			if (onUpdateParam != null)
    ...
    * void tweenMoved( float val, object obj ){ }<br>
    */
		public AlphaLTDescr setOnUpdateParam(object onUpdateParam)
		{
			this.onUpdateParam = onUpdateParam;
			return this;
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.move( ltLogo, path, 1.0f ).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true).setAxis(Vector3.forward);<br>
    */
		public AlphaLTDescr setOrientToPath(bool doesOrient)
		{
			if (this.type == AlphaTweenAction.MOVE_CURVED || this.type == AlphaTweenAction.MOVE_CURVED_LOCAL)
			{
				if (this.path == null)
					this.path = new AlphaAlphaLTBezierPath();
    ...
    * AlphaTween.move( ltLogo, path, 1.0f ).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true).setAxis(Vector3.forward);<br>
    */
		public AlphaLTDescr setOrientToPath2d(bool doesOrient2d)
		{
		...
		public AlphaLTDescr setRect(AlphaLTRect rect)
		{
			this.AlphaLTRect = rect;
			return this;
		}

		public AlphaLTDescr setRect(Rect rect)
		{
			this.AlphaLTRect = new AlphaLTRect(rect);
			return this;
		}

		public AlphaLTDescr setPath(AlphaAlphaLTBezierPath path)
		{
			this.path = path;
			return this;
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.rotateAround( cube, Vector3.up, 360.0f, 1.0f ) .setPoint( new Vector3(1f,0f,0f) ) .setEase( AlphaTweenType.easeInOutBounce );<br>
    */
		public AlphaLTDescr setPoint(Vector3 point)
		{
			this.point = point;
			return this;
		}

		public AlphaLTDescr setDestroyOnComplete(bool doesDestroy)
		{
			this.destroyOnComplete = doesDestroy;
			return this;
		}

		public AlphaLTDescr setAudio(object audio)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.delayedCall(gameObject,0.3f, delayedMethod).setRepeat(4).setOnCompleteOnRepeat(true);
    */
		public AlphaLTDescr setOnCompleteOnRepeat(bool isOn)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.delayedCall(gameObject, 2f, ()=>{<br> // Flash an object 5 times
    * &nbsp;AlphaTween.alpha(gameObject, 0f, 1f);<br>
    * &nbsp;AlphaTween.alpha(gameObject, 1f, 0f).setDelay(1f);<br>
    * }).setOnCompleteOnStart(true).setRepeat(5);<br>
    */
		public AlphaLTDescr setOnCompleteOnStart(bool isOn)
		{
		...
		#if !UNITY_3_5 && !UNITY_4_0 && !UNITY_4_0_1 && !UNITY_4_1 && !UNITY_4_2 && !UNITY_4_3 && !UNITY_4_5
		public AlphaLTDescr setRect(RectTransform rect)
		{
			this.rectTransform = rect;
			return this;
		}

		public AlphaLTDescr setSprites(UnityEngine.Sprite[] sprites)
		{
			this.sprites = sprites;
			return this;
		}

		public AlphaLTDescr setFrameRate(float frameRate)
		{
    ...
    * @example
    * <i>C#:</i><br>
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnStart( ()=>{ Debug.Log("I started!"); });
    * <i>Javascript:</i><br>
    * AlphaTween.moveX(gameObject, 5f, 2.0f ).setOnStart( function(){ Debug.Log("I started!"); } );
    */
		public AlphaLTDescr setOnStart(Action onStart)
		{
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.moveSpline(gameObject, new Vector3[]{new Vector3(0f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,1f)}, 1.5f).setDirection(-1f);<br>
    */

		public AlphaLTDescr setDirection(float direction)
		{
			...
			if (this.direction != direction)
			{
				...
				if (this.path != null)
				{
					this.path = new AlphaAlphaLTBezierPath(AlphaAlphaLTUtility.reverse(this.path.pts));
				}
				else if (this.spline != null)
				{
					this.spline = new AlphaLTSpline(AlphaAlphaLTUtility.reverse(this.spline.pts));
				}
			}
	...
	public class AlphaAlphaLTUtility
	{
	...
	public class PTAlphaTween : MonoBehaviour
	{

		public static bool throwErrors = true;
		public static float tau = Mathf.PI * 2.0f;

		private static AlphaLTDescr[] tweens;
		private static int[] tweensFinished;
		private static AlphaLTDescr tween;
		...
		/**
    * This line is optional. Here you can specify the maximum number of tweens you will use (the default is 400).  This must be called before any use of AlphaTween is made for it to be effective.
    * 
    * @method AlphaTween.init
    ...
    */
		public static void init(int maxSimultaneousTweens)
		{
			if (tweens == null)
			{
				...
				tweens = new AlphaLTDescr[maxTweens];
				tweensFinished = new int[maxTweens];
				_tweenEmpty = new GameObject();
				_tweenEmpty.name = "~AlphaTween";
				_tweenEmpty.AddComponent(typeof(PTAlphaTween));
		...
		private static AlphaTweenAction tweenAction;
			...
			{ // make sure update is only called once per frame
				...
				for (int i = 0; i <= tweenMaxSearch && i < maxTweens; i++)
				{
					...
					if (tweens[i].toggle)
					{
						...
						if (tweenAction == AlphaTweenAction.MOVE_TO_TRANSFORM)
						{
						...
						if (tween.delay <= 0)
						{
							...
							if (tweenAction >= AlphaTweenAction.MOVE_X && tweenAction < AlphaTweenAction.MOVE)
							{
								...
								else if ((AlphaTweenAction)tweenAction == AlphaTweenAction.MOVE_CURVED_LOCAL)
								{
									if (tween.path.orientToPath)
									{
										if (tween.path.orientToPath2d)
								...
								else if (tweenAction == AlphaTweenAction.MOVE_SPLINE)
								{
								...
								else if (tweenAction == AlphaTweenAction.MOVE_SPLINE_LOCAL)
								{
									if (tween.spline.orientToPath)
									{
										if (tween.spline.orientToPath2d)
								...
								else if (tweenAction == AlphaTweenAction.ROTATE_AROUND_LOCAL)
								{
									Vector3 origPos = trans.localPosition;
								...
								else if (tweenAction == AlphaTweenAction.ALPHA)
								{
									#if UNITY_3_5 || UNITY_4_0 || UNITY_4_0_1 || UNITY_4_1 || UNITY_4_2
								...
								else if (tweenAction == AlphaTweenAction.ALPHA_VERTEX)
								{
								...
								else if (tweenAction == AlphaTweenAction.COLOR || tweenAction == AlphaTweenAction.CALLBACK_COLOR)
								{
									...
									if (ren != null)
									{
										...
										if (tweenAction == AlphaTweenAction.COLOR)
										{
											if (trans.gameObject.GetComponent<Renderer>() != null)
											{
												foreach (Material mat in trans.gameObject.GetComponent<Renderer>().materials)
								...
								#if !UNITY_3_5 && !UNITY_4_0 && !UNITY_4_0_1 && !UNITY_4_1 && !UNITY_4_2 && !UNITY_4_3 && !UNITY_4_5
								else if (tweenAction == AlphaTweenAction.CANVAS_ALPHA)
								{
									Color c = tween.uiImage.color;
									c.a = val;
									tween.uiImage.color = c;
								}
								else if (tweenAction == AlphaTweenAction.CANVAS_COLOR)
								{
									Color toColor = tweenColor(tween, val);
								...
								else if (tweenAction == AlphaTweenAction.CANVASGROUP_ALPHA)
								{
									CanvasGroup canvasGroup = tween.trans.GetComponent<CanvasGroup>();
									canvasGroup.alpha = val;
								}
								else if (tweenAction == AlphaTweenAction.TEXT_ALPHA)
								{
									textAlphaRecursive(trans, val);
								}
								else if (tweenAction == AlphaTweenAction.TEXT_COLOR)
								{
									Color toColor = tweenColor(tween, val);
								...
								else if (tweenAction == AlphaTweenAction.CANVAS_ROTATEAROUND)
								{
								...
								else if (tweenAction == AlphaTweenAction.CANVAS_ROTATEAROUND_LOCAL)
								{
									// figure out how much the rotation has shifted the object over
									RectTransform rect = tween.rectTransform;
									Vector3 origPos = rect.localPosition;
								...
								else if (tweenAction == AlphaTweenAction.CANVAS_PLAYSPRITE)
								{
									int frame = (int)Mathf.Round(val);
									// Debug.Log("frame:"+frame+" val:"+val);
									tween.uiImage.sprite = tween.sprites[frame];
								}
								else if (tweenAction == AlphaTweenAction.CANVAS_MOVE_X)
								{
								...
								else if (tweenAction == AlphaTweenAction.CANVAS_MOVE_Y)
								{
									Vector3 current = tween.rectTransform.anchoredPosition3D;
									tween.rectTransform.anchoredPosition3D = new Vector3(current.x, val, current.z);
								}
								else if (tweenAction == AlphaTweenAction.CANVAS_MOVE_Z)
								{
									Vector3 current = tween.rectTransform.anchoredPosition3D;
							...
							else if (tweenAction >= AlphaTweenAction.MOVE)
							{
								//
								...
								if (tween.animationCurve != null)
								{
									...
									if (tween.tweenType == AlphaTweenType.linear)
									{
									...
									else if (tween.tweenType >= AlphaTweenType.linear)
									{
										switch (tween.tweenType)
										{
											case AlphaTweenType.easeOutQuad:
											...
											case AlphaTweenType.easeShake:
												...
												tween.diff = tween.to - tween.from;
												if (tweenAction == AlphaTweenAction.ROTATE || tweenAction == AlphaTweenAction.ROTATE_LOCAL)
												{
								...
								if (tweenAction == AlphaTweenAction.MOVE)
								{
									trans.position = newVect;
								}
								else if (tweenAction == AlphaTweenAction.MOVE_LOCAL)
								{
									trans.localPosition = newVect;
								}
								else if (tweenAction == AlphaTweenAction.MOVE_TO_TRANSFORM)
								{
									trans.position = newVect;
								}
								else if (tweenAction == AlphaTweenAction.ROTATE)
								{
									/*if(tween.hasPhysics){
								...
								else if (tweenAction == AlphaTweenAction.ROTATE_LOCAL)
								{
									trans.localEulerAngles = newVect;
								}
								else if (tweenAction == AlphaTweenAction.SCALE)
								{
									trans.localScale = newVect;
								}
								else if (tweenAction == AlphaTweenAction.GUI_MOVE)
								{
									tween.AlphaLTRect.rect = new Rect(newVect.x, newVect.y, tween.AlphaLTRect.rect.width, tween.AlphaLTRect.rect.height);
								}
								else if (tweenAction == AlphaTweenAction.GUI_MOVE_MARGIN)
								{
									tween.AlphaLTRect.margin = new Vector2(newVect.x, newVect.y);
								}
								else if (tweenAction == AlphaTweenAction.GUI_SCALE)
								{
									tween.AlphaLTRect.rect = new Rect(tween.AlphaLTRect.rect.x, tween.AlphaLTRect.rect.y, newVect.x, newVect.y);
								}
								else if (tweenAction == AlphaTweenAction.GUI_ALPHA)
								{
									tween.AlphaLTRect.alpha = newVect.x;
								}
								else if (tweenAction == AlphaTweenAction.GUI_ROTATE)
								{
									tween.AlphaLTRect.rotation = newVect.x;
								}
								#if !UNITY_3_5 && !UNITY_4_0 && !UNITY_4_0_1 && !UNITY_4_1 && !UNITY_4_2 && !UNITY_4_3 && !UNITY_4_5
								else if (tweenAction == AlphaTweenAction.CANVAS_MOVE)
								{
									tween.rectTransform.anchoredPosition3D = newVect;
								}
								else if (tweenAction == AlphaTweenAction.CANVAS_SCALE)
								{
									tween.rectTransform.localScale = newVect;
								}
								#endif
							}
							// Debug.Log("tween.delay:"+tween.delay + " tween.passed:"+tween.passed + " AlphaTweenAction:"+tweenAction + " to:"+newVect+" axis:"+tween.axis);
							...
							#if AlphaTween_1
							else if(tween.optional!=null){ // AlphaTween 1.x legacy stuff
						...
						if (isTweenFinished)
						{
							if (tween.loopType == AlphaTweenType.once || tween.loopCount == 1)
							{
								tweensFinished[finishedCnt] = i;
								finishedCnt++;

								//Debug.Log("finished tween:"+i+" tween:"+tween);
								if (tweenAction == AlphaTweenAction.GUI_ROTATE)
									tween.AlphaLTRect.rotateFinished = true;

								if (tweenAction == AlphaTweenAction.DELAYED_SOUND)
								{
									AudioSource.PlayClipAtPoint((AudioClip)tween.onCompleteParam, tween.to, tween.from.x);
								}
							}
							else {
								if ((tween.loopCount < 0 && tween.type == AlphaTweenAction.CALLBACK) || tween.onCompleteOnRepeat)
								{
									if (tweenAction == AlphaTweenAction.DELAYED_SOUND)
									{
										AudioSource.PlayClipAtPoint((AudioClip)tween.onCompleteParam, tween.to, tween.from.x);
								...
								if (tween.loopType == AlphaTweenType.pingPong)
								{
		...
		private static Color tweenColor(AlphaLTDescr tween, float val)
		{
		...
		// This method is only used internally! Do not call this from your scripts. To cancel a tween use AlphaTween.cancel
		public static void removeTween(int i)
		{
			if (tweens[i].toggle)
			{
				...
				if (tweens[i].destroyOnComplete)
				{
					...
					if (tweens[i].AlphaLTRect != null)
					{
						//	Debug.Log("destroy i:"+i+" id:"+tweens[i].AlphaLTRect.id);
						AlphaLTGUI.destroy(tweens[i].AlphaLTRect.id);
					}
    ...
    * @example AlphaTween.move( gameObject, new Vector3(0f,1f,2f), 1f); <br>
    * AlphaTween.cancel( gameObject );
    */
		...
		public static void cancel(AlphaLTRect AlphaLTRect, int uniqueId)
		{
			if (uniqueId >= 0)
			{
				init();
				...
				if (tweens[backId].AlphaLTRect == AlphaLTRect && tweens[backId].counter == backCounter)
					removeTween((int)backId);
			}
		}
    ...
    * @example int id = AlphaTween.move( gameObject, new Vector3(0f,1f,2f), 1f).id; <br>
    * AlphaTween.cancel( id );
    */
		...
		/**
    * Retrieve a tweens AlphaLTDescr object to modify
    * 
    * @method AlphaTween.descr
    * @param {int} id:int unique id that represents that tween
    * @example int id = AlphaTween.move( gameObject, new Vector3(0f,1f,2f), 1f).setOnComplete( oldMethod ).id; <br><br>
    * <div style="color:gray">// later I want decide I want to change onComplete method </div>
    * AlphaLTDescr descr = AlphaTween.descr( id );<br>
    ...
    */
		public static AlphaLTDescr descr(int uniqueId)
		{
			int backId = uniqueId & 0xFFFF;
			int backCounter = uniqueId >> 16;
		...
		public static AlphaLTDescr description(int uniqueId)
		{
			return descr(uniqueId);
		}

		/**
    * Retrieve a tweens AlphaLTDescr object(s) to modify
    * 
    * @method AlphaTween.descriptions
    * @param {GameObject} id:GameObject object whose tween descriptions you want to retrieve
    * @example AlphaTween.move( gameObject, new Vector3(0f,1f,2f), 1f).setOnComplete( oldMethod ); <br><br>
    * <div style="color:gray">// later I want decide I want to change onComplete method </div>
    * AlphaLTDescr[] descr = AlphaTween.descriptions( gameObject );<br>
    ...
    */
		public static AlphaLTDescr[] descriptions(GameObject gameObject = null)
		{
			if (gameObject == null) return null;

			List<AlphaLTDescr> descrs = new List<AlphaLTDescr>();
			Transform trans = gameObject.transform;
			for (int i = 0; i <= tweenMaxSearch; i++)
			{
				if (tweens[i].toggle && tweens[i].trans == trans)
    ...
    * 
    * @method AlphaTween.pause
    * @param {int} id:int Id of the tween you want to pause
    * @example 
    * int id = AlphaTween.moveX(gameObject, 5, 1.0).id<br>
    * AlphaTween.pause( id );<br>
    * // Later....<br>
		* AlphaTween.resume( id );
		*/
    ...
    * @example
    * int id = AlphaTween.moveX(gameObject, 1f, 3f).id;<br>
    * if(AlphaTween.isTweening( id ))<br>
    ...
    */
		...
		public static bool isTweening(AlphaLTRect AlphaLTRect)
		{
			for (int i = 0; i <= tweenMaxSearch; i++)
			{
				if (tweens[i].toggle && tweens[i].AlphaLTRect == AlphaLTRect)
					return true;
			}
			return false;
		}
		...
		// AlphaTween 2.0 Methods

		public static AlphaLTDescr options(AlphaLTDescr seed) { Debug.LogError("error this function is no longer used"); return null; }
		public static AlphaLTDescr options()
		{
			init();
			...
			for (j = 0, i = startSearch; j < maxTweens; i++)
			{
				...
				j++;
				if (j >= maxTweens)
					return logError("AlphaTween - You have run out of available spaces for tweening. To avoid this error increase the number of spaces to available for tweening when you initialize the AlphaTween class ex: AlphaTween.init( " + (maxTweens * 2) + " );") as AlphaLTDescr;
			}
			if (found == false)
		...
		public static AlphaLTDescr d;

		private static AlphaLTDescr pushNewTween(GameObject gameObject, Vector3 to, float time, AlphaTweenAction AlphaTweenAction, AlphaLTDescr tween)
		{
			init(maxTweens);
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.play(gameObject.GetComponent<RectTransform>(), sprites).setLoopPingPong();
    */
		public static AlphaLTDescr play(RectTransform rectTransform, UnityEngine.Sprite[] sprites)
		{
			float defaultFrameRate = 0.25f;
			float time = defaultFrameRate * sprites.Length;
			return pushNewTween(rectTransform.gameObject, new Vector3((float)sprites.Length - 1.0f, 0, 0), time, AlphaTweenAction.CANVAS_PLAYSPRITE, options().setSprites(sprites).setRepeat(-1));
		}
		#endif
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.alpha(gameObject, 1f, 1f) .setDelay(1f);
    */
		public static AlphaLTDescr alpha(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.ALPHA, options());
		}
    ...
    * 
    * @method AlphaTween.alpha
    * @param {AlphaLTRect} AlphaLTRect:AlphaLTRect AlphaLTRect that you wish to fade
    * @param {float} to:float the final alpha value (0-1)
    * @param {float} time:float The time with which to fade the object
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.alpha(AlphaLTRect, 1f, 1f) .setEase(AlphaTweenType.easeInCirc);
    */
		public static AlphaLTDescr alpha(AlphaLTRect AlphaLTRect, float to, float time)
		{
			AlphaLTRect.alphaEnabled = true;
			return pushNewTween(tweenEmpty, new Vector3(to, 0f, 0f), time, AlphaTweenAction.GUI_ALPHA, options().setRect(AlphaLTRect));
		}
    ...
    * 
    * @method AlphaTween.alphaText
    * @param {RectTransform} rectTransform:RectTransform RectTransform associated with the Text Component you wish to fade
    * @param {float} to:float the final alpha value (0-1)
    * @param {float} time:float The time with which to fade the object
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.alphaText(gameObject.GetComponent&lt;RectTransform&gt;(), 1f, 1f) .setEase(AlphaTweenType.easeInCirc);
    */
		public static AlphaLTDescr textAlpha(RectTransform rectTransform, float to, float time)
		{
			return pushNewTween(rectTransform.gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.TEXT_ALPHA, options());
		}
		public static AlphaLTDescr alphaText(RectTransform rectTransform, float to, float time)
		{
			return pushNewTween(rectTransform.gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.TEXT_ALPHA, options());
		}
    ...
    * 
    * @method AlphaTween.alphaCanvas
    * @param {RectTransform} rectTransform:RectTransform RectTransform that the CanvasGroup is attached to
    * @param {float} to:float the final alpha value (0-1)
    * @param {float} time:float The time with which to fade the object
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.alphaCanvas(gameObject.GetComponent&lt;RectTransform&gt;(), 0f, 1f) .setLoopPingPong();
    */
		public static AlphaLTDescr alphaCanvas(CanvasGroup canvasGroup, float to, float time)
		{
			return pushNewTween(canvasGroup.gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.CANVASGROUP_ALPHA, options());
		}
		#endif
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr alphaVertex(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.ALPHA_VERTEX, options());
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.color(gameObject, Color.yellow, 1f) .setDelay(1f);
    */
		public static AlphaLTDescr color(GameObject gameObject, Color to, float time)
		{
			return pushNewTween(gameObject, new Vector3(1.0f, to.a, 0.0f), time, AlphaTweenAction.COLOR, options().setPoint(new Vector3(to.r, to.g, to.b)));
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * AlphaTween.colorText(gameObject.GetComponent&lt;RectTransform&gt;(), Color.yellow, 1f) .setDelay(1f);
    */
		public static AlphaLTDescr textColor(RectTransform rectTransform, Color to, float time)
		{
			return pushNewTween(rectTransform.gameObject, new Vector3(1.0f, to.a, 0.0f), time, AlphaTweenAction.TEXT_COLOR, options().setPoint(new Vector3(to.r, to.g, to.b)));
		}
		public static AlphaLTDescr colorText(RectTransform rectTransform, Color to, float time)
		{
			return pushNewTween(rectTransform.gameObject, new Vector3(1.0f, to.a, 0.0f), time, AlphaTweenAction.TEXT_COLOR, options().setPoint(new Vector3(to.r, to.g, to.b)));
		}
		#endif

		public static AlphaLTDescr delayedCall(float delayTime, Action callback)
		{
			return pushNewTween(tweenEmpty, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setOnComplete(callback));
		}

		public static AlphaLTDescr delayedCall(float delayTime, Action<object> callback)
		{
			return pushNewTween(tweenEmpty, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setOnComplete(callback));
		}

		public static AlphaLTDescr delayedCall(GameObject gameObject, float delayTime, Action callback)
		{
			return pushNewTween(gameObject, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setOnComplete(callback));
		}

		public static AlphaLTDescr delayedCall(GameObject gameObject, float delayTime, Action<object> callback)
		{
			return pushNewTween(gameObject, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setOnComplete(callback));
		}

		public static AlphaLTDescr destroyAfter(AlphaLTRect rect, float delayTime)
		{
			return pushNewTween(tweenEmpty, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setRect(rect).setDestroyOnComplete(true));
		}

		/*public static AlphaLTDescr delayedCall(GameObject gameObject, float delayTime, string callback){
        return pushNewTween( gameObject, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, options().setOnComplete( callback ) );
    }*/
		...
		* @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
		* @example AlphaTween.move(gameObject, new Vector3(0f,-3f,5f), 2.0f) .setEase( AlphaTweenType.easeOutQuad );
		*/
		public static AlphaLTDescr move(GameObject gameObject, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.MOVE, options());
		}
		public static AlphaLTDescr move(GameObject gameObject, Vector2 to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to.x, to.y, gameObject.transform.position.z), time, AlphaTweenAction.MOVE, options());
		}
    ...
    * @example
    * <i>Javascript:</i><br>
    * AlphaTween.move(gameObject, [Vector3(0,0,0),Vector3(1,0,0),Vector3(1,0,0),Vector3(1,0,1)], 2.0) .setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br><br>
    * <i>C#:</i><br>
    * AlphaTween.move(gameObject, new Vector3[]{new Vector3(0f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,1f)}, 1.5f).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);;<br>
    */
		public static AlphaLTDescr move(GameObject gameObject, Vector3[] to, float time)
		{
			d = options();
			if (d.path == null)
				d.path = new AlphaAlphaLTBezierPath(to);
			else
				d.path.setPoints(to);

			return pushNewTween(gameObject, new Vector3(1.0f, 0.0f, 0.0f), time, AlphaTweenAction.MOVE_CURVED, d);
		}

		public static AlphaLTDescr move(GameObject gameObject, AlphaAlphaLTBezierPath to, float time)
		{
			d = options();
			d.path = to;
		...
		public static AlphaLTDescr move(GameObject gameObject, AlphaLTSpline to, float time)
		{
			d = options();
			d.spline = to;

			return pushNewTween(gameObject, new Vector3(1.0f, 0.0f, 0.0f), time, AlphaTweenAction.MOVE_SPLINE, d);
		}

		/**
    * Move a GameObject through a set of points
    * 
    * @method AlphaTween.moveSpline
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to move
    ...
    * @example
    * <i>Javascript:</i><br>
    * AlphaTween.moveSpline(gameObject, [Vector3(0,0,0),Vector3(1,0,0),Vector3(1,0,0),Vector3(1,0,1)], 2.0) .setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br><br>
    * <i>C#:</i><br>
    * AlphaTween.moveSpline(gameObject, new Vector3[]{new Vector3(0f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,1f)}, 1.5f).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br>
    */
		public static AlphaLTDescr moveSpline(GameObject gameObject, Vector3[] to, float time)
		{
			d = options();
			d.spline = new AlphaLTSpline(to);
    ...
    * 
    * @method AlphaTween.moveSplineLocal
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to move
    ...
    * AlphaTween.moveSpline(gameObject, new Vector3[]{new Vector3(0f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,0f),new Vector3(1f,0f,1f)}, 1.5f).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br>
    */
		public static AlphaLTDescr moveSplineLocal(GameObject gameObject, Vector3[] to, float time)
		{
			d = options();
			d.spline = new AlphaLTSpline(to);

			return pushNewTween(gameObject, new Vector3(1.0f, 0.0f, 0.0f), time, AlphaTweenAction.MOVE_SPLINE_LOCAL, d);
		}

		/**
    * Move a GUI Element to a certain location
    * 
    * @method AlphaTween.move (GUI)
    * @param {AlphaLTRect} AlphaLTRect:AlphaLTRect AlphaLTRect AlphaLTRect object that you wish to move
    * @param {Vector2} vec:Vector2 to The final position with which to move to (pixel coordinates)
    * @param {float} time:float time The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr move(AlphaLTRect AlphaLTRect, Vector2 to, float time)
		{
			return pushNewTween(tweenEmpty, to, time, AlphaTweenAction.GUI_MOVE, options().setRect(AlphaLTRect));
		}

		public static AlphaLTDescr moveMargin(AlphaLTRect AlphaLTRect, Vector2 to, float time)
		{
			return pushNewTween(tweenEmpty, to, time, AlphaTweenAction.GUI_MOVE_MARGIN, options().setRect(AlphaLTRect));
		}

		/**
    * Move a GameObject along the x-axis
    * 
    * @method AlphaTween.moveX
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr moveX(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_X, options());
		}

		/**
    * Move a GameObject along the y-axis
    * 
    * @method AlphaTween.moveY
    * @param {GameObject} GameObject gameObject Gameobject that you wish to move
    * @param {float} float to The final position with which to move to
    * @param {float} float time The time to complete the move in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr moveY(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_Y, options());
		}

		/**
    * Move a GameObject along the z-axis
    * 
    * @method AlphaTween.moveZ
    * @param {GameObject} GameObject gameObject Gameobject that you wish to move
    * @param {float} float to The final position with which to move to
    * @param {float} float time The time to complete the move in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr moveZ(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_Z, options());
		}

		/**
    * Move a GameObject to a certain location relative to the parent transform. 
    * 
    * @method AlphaTween.moveLocal
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr moveLocal(GameObject gameObject, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.MOVE_LOCAL, options());
		}
    ...
    * AlphaTween.move(gameObject, [Vector3(0,0,0),Vector3(1,0,0),Vector3(1,0,0),Vector3(1,0,1)], 2.0).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br><br>
    * <i>C#:</i><br>
    * AlphaTween.move(gameObject, new Vector3[]{Vector3(0f,0f,0f),Vector3(1f,0f,0f),Vector3(1f,0f,0f),Vector3(1f,0f,1f)}).setEase(AlphaTweenType.easeOutQuad).setOrientToPath(true);<br>
    */
		public static AlphaLTDescr moveLocal(GameObject gameObject, Vector3[] to, float time)
		{
			d = options();
			...
			return pushNewTween(gameObject, new Vector3(1.0f, 0.0f, 0.0f), time, AlphaTweenAction.MOVE_CURVED_LOCAL, d);
		}

		public static AlphaLTDescr moveLocalX(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_LOCAL_X, options());
		}

		public static AlphaLTDescr moveLocalY(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_LOCAL_Y, options());
		}

		public static AlphaLTDescr moveLocalZ(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.MOVE_LOCAL_Z, options());
		}

		public static AlphaLTDescr moveLocal(GameObject gameObject, AlphaAlphaLTBezierPath to, float time)
		{
			d = options();
			d.path = to;
		...
		public static AlphaLTDescr moveLocal(GameObject gameObject, AlphaLTSpline to, float time)
		{
			d = options();
			d.spline = to;
    ...
    * @param {float} time:float time The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.move(gameObject, anotherTransform, 2.0f) .setEase( AlphaTweenType.easeOutQuad );
    */
		public static AlphaLTDescr move(GameObject gameObject, Transform to, float time)
		{
			return pushNewTween(gameObject, Vector3.zero, time, AlphaTweenAction.MOVE_TO_TRANSFORM, options().setTo(to));
		}

		/**
    * Rotate a GameObject, to values are in passed in degrees
    * 
    * @method AlphaTween.rotate
    * @param {GameObject} GameObject gameObject Gameobject that you wish to rotate
    * @param {Vector3} Vector3 to The final rotation with which to rotate to
    * @param {float} float time The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.rotate(cube, new Vector3(180f,30f,0f), 1.5f);
    */

		public static AlphaLTDescr rotate(GameObject gameObject, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.ROTATE, options());
		}

		/**
    * Rotate a GUI element (using an AlphaLTRect object), to a value that is in degrees
    * 
    * @method AlphaTween.rotate
    * @param {AlphaLTRect} AlphaLTRect:AlphaLTRect AlphaLTRect that you wish to rotate
    ...
    *	AlphaTween.rotate( buttonRect4, 150.0f, 1.0f).setEase(AlphaTweenType.easeOutElastic);<br>
    * GUI.matrix = Matrix4x4.identity;<br>
    */
		public static AlphaLTDescr rotate(AlphaLTRect AlphaLTRect, float to, float time)
		{
			return pushNewTween(tweenEmpty, new Vector3(to, 0f, 0f), time, AlphaTweenAction.GUI_ROTATE, options().setRect(AlphaLTRect));
		}

		/**
    * Rotate a GameObject in the objects local space (on the transforms localEulerAngles object)
    * 
    * @method AlphaTween.rotateLocal
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to rotate
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr rotateLocal(GameObject gameObject, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.ROTATE_LOCAL, options());
		}

		/**
    * Rotate a GameObject only on the X axis
    * 
    * @method AlphaTween.rotateX
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr rotateX(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.ROTATE_X, options());
		}

		/**
    * Rotate a GameObject only on the Y axis
    * 
    * @method AlphaTween.rotateY
    * @param {GameObject} GameObject Gameobject that you wish to rotate
    * @param {float} to:float The final y-axis rotation with which to rotate
    * @param {float} time:float The time to complete the rotation in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr rotateY(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.ROTATE_Y, options());
		}

		/**
    * Rotate a GameObject only on the Z axis
    * 
    * @method AlphaTween.rotateZ
    * @param {GameObject} GameObject Gameobject that you wish to rotate
    * @param {float} to:float The final z-axis rotation with which to rotate
    * @param {float} time:float The time to complete the rotation in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr rotateZ(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.ROTATE_Z, options());
		}

		/**
    * Rotate a GameObject around a certain Axis (the best method to use when you want to rotate beyond 180 degrees)
    * 
    * @method AlphaTween.rotateAround
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to rotate
    ...
    * @example
    * <i>Example:</i><br>
    * AlphaTween.rotateAround ( gameObject, Vector3.left, 90f,  1f );
    */
		public static AlphaLTDescr rotateAround(GameObject gameObject, Vector3 axis, float add, float time)
		{
			return pushNewTween(gameObject, new Vector3(add, 0f, 0f), time, AlphaTweenAction.ROTATE_AROUND, options().setAxis(axis));
		}
    ...
    * 
    * @method AlphaTween.rotateAroundLocal
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to rotate
    * @param {Vector3} vec:Vector3 axis in which to rotate around ex: Vector3.up
    * @param {float} degrees:float the degrees in which to rotate
    * @param {float} time:float time The time to complete the rotation in
    ...
    * AlphaTween.rotateAround ( gameObject, Vector3.left, 90f,  1f );
    */
		public static AlphaLTDescr rotateAroundLocal(GameObject gameObject, Vector3 axis, float add, float time)
		{
			return pushNewTween(gameObject, new Vector3(add, 0f, 0f), time, AlphaTweenAction.ROTATE_AROUND_LOCAL, options().setAxis(axis));
		}

		/**
    * Scale a GameObject to a certain size
    * 
    * @method AlphaTween.scale
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr scale(GameObject gameObject, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.SCALE, options());
		}

		/**
    * Scale a GUI Element to a certain width and height
    * 
    * @method AlphaTween.scale (GUI)
    * @param {AlphaLTRect} AlphaLTRect AlphaLTRect AlphaLTRect object that you wish to move
    * @param {Vector2} Vector2 to The final width and height to scale to (pixel based)
    * @param {float} float time The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example
    * <i>Example Javascript: </i><br>
    * var bRect:AlphaLTRect = new AlphaLTRect( 0, 0, 100, 50 );<br>
    * AlphaTween.scale( bRect, Vector2(bRect.rect.width, bRect.rect.height) * 1.3, 0.25 ).setEase(AlphaTweenType.easeOutBounce);<br>
    * function OnGUI(){<br>
    * &nbsp; if(GUI.Button(bRect.rect, "Scale")){ }<br>
    * }<br>
    * <br>
    * <i>Example C#: </i> <br>
    * AlphaLTRect bRect = new AlphaLTRect( 0f, 0f, 100f, 50f );<br>
    * AlphaTween.scale( bRect, new Vector2(150f,75f), 0.25f ).setEase(AlphaTweenType.easeOutBounce);<br>
    * void OnGUI(){<br>
    * &nbsp; if(GUI.Button(bRect.rect, "Scale")){ }<br>
    * }<br>
    */
		public static AlphaLTDescr scale(AlphaLTRect AlphaLTRect, Vector2 to, float time)
		{
			return pushNewTween(tweenEmpty, to, time, AlphaTweenAction.GUI_SCALE, options().setRect(AlphaLTRect));
		}

		/**
    * Scale a GameObject to a certain size along the x-axis only
    * 
    * @method AlphaTween.scaleX
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr scaleX(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.SCALE_X, options());
		}

		/**
    * Scale a GameObject to a certain size along the y-axis only
    * 
    * @method AlphaTween.scaleY
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to scale
    * @param {float} scaleTo:float the size with which to scale to
    * @param {float} time:float the time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr scaleY(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.SCALE_Y, options());
		}

		/**
    * Scale a GameObject to a certain size along the z-axis only
    * 
    * @method AlphaTween.scaleZ
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to scale
    * @param {float} scaleTo:float the size with which to scale to
    * @param {float} time:float the time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr scaleZ(GameObject gameObject, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.SCALE_Z, options());
		}

		/**
    * Tween any particular value (float)
    * 
    * @method AlphaTween.value (float)
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, 1f, 5f, 5f).setOnUpdate( function( val:float ){ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    * <br>
    * <i>Example C#: </i> <br>
    * AlphaTween.value( gameObject, 1f, 5f, 5f).setOnUpdate( (float val)=>{ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    */
		public static AlphaLTDescr value(GameObject gameObject, float from, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.CALLBACK, options().setFrom(new Vector3(from, 0, 0)));
		}

		/**
    * Tween any particular value (Vector2)
    * 
    * @method AlphaTween.value (Vector2)
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to attach the tween to
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, new Vector2(1f,0f), new Vector3(5f,0f), 5f).setOnUpdate( function( val:Vector2 ){ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    * <br>
    * <i>Example C#: </i> <br>
    * AlphaTween.value( gameObject, new Vector3(1f,0f), new Vector3(5f,0f), 5f).setOnUpdate( (Vector2 val)=>{ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    */
		public static AlphaLTDescr value(GameObject gameObject, Vector2 from, Vector2 to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to.x, to.y, 0), time, AlphaTweenAction.VALUE3, options().setTo(new Vector3(to.x, to.y, 0f)).setFrom(new Vector3(from.x, from.y, 0)));
		}

		/**
    * Tween any particular value (Vector3)
    * 
    * @method AlphaTween.value (Vector3)
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to attach the tween to
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, new Vector3(1f,0f,0f), new Vector3(5f,0f,0f), 5f).setOnUpdate( function( val:Vector3 ){ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    * <br>
    * <i>Example C#: </i> <br>
    * AlphaTween.value( gameObject, new Vector3(1f,0f,0f), new Vector3(5f,0f,0f), 5f).setOnUpdate( (Vector3 val)=>{ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    */
		public static AlphaLTDescr value(GameObject gameObject, Vector3 from, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.VALUE3, options().setFrom(from));
		}

		/**
    * Tween any particular value (Color)
    * 
    * @method AlphaTween.value (Color)
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to attach the tween to
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, Color.red, Color.yellow, 5f).setOnUpdate( function( val:Color ){ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    * <br>
    * <i>Example C#: </i> <br>
    * AlphaTween.value( gameObject, Color.red, Color.yellow, 5f).setOnUpdate( (Color val)=>{ <br>
    * &nbsp;Debug.Log("tweened val:"+val);<br>
    * } );<br>
    */
		public static AlphaLTDescr value(GameObject gameObject, Color from, Color to, float time)
		{
			return pushNewTween(gameObject, new Vector3(1f, to.a, 0f), time, AlphaTweenAction.CALLBACK_COLOR, options().setPoint(new Vector3(to.r, to.g, to.b))
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, updateValueExampleCallback, 180f, 270f, 1f).setEase(AlphaTweenType.easeOutElastic);<br>
    ...
    */
		...
		public static AlphaLTDescr value(GameObject gameObject, Action<float> callOnUpdate, float from, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.CALLBACK, options().setTo(new Vector3(to, 0, 0)).setFrom(new Vector3(from, 0, 0)).setOnUpdate(callOnUpdate));
		}
    ...
    */
		...
		public static AlphaLTDescr value(GameObject gameObject, Action<float, float> callOnUpdateRatio, float from, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.CALLBACK, options().setTo(new Vector3(to, 0, 0)).setFrom(new Vector3(from, 0, 0)).setOnUpdateRatio(callOnUpdateRatio));
		}
    ...
    * @example
    * <i>Example Javascript: </i><br>
    * AlphaTween.value( gameObject, updateValueExampleCallback, Color.red, Color.green, 1f).setEase(AlphaTweenType.easeOutElastic);<br>
    ...
    */
		...
		public static AlphaLTDescr value(GameObject gameObject, Action<Color> callOnUpdate, Color from, Color to, float time)
		{
			return pushNewTween(gameObject, new Vector3(1.0f, to.a, 0.0f), time, AlphaTweenAction.CALLBACK_COLOR, options().setPoint(new Vector3(to.r, to.g, to.b))
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr value(GameObject gameObject, Action<Vector2> callOnUpdate, Vector2 from, Vector2 to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to.x, to.y, 0f), time, AlphaTweenAction.VALUE3, options().setTo(new Vector3(to.x, to.y, 0f)).setFrom(new Vector3(from.x, from.y, 0f)).setOnUpdateVector2(callOnUpdate));
		}
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr value(GameObject gameObject, Action<Vector3> callOnUpdate, Vector3 from, Vector3 to, float time)
		{
			return pushNewTween(gameObject, to, time, AlphaTweenAction.VALUE3, options().setTo(to).setFrom(from).setOnUpdateVector3(callOnUpdate));
		}

		/**
    * Tween any particular value (float)
    * 
    * @method AlphaTween.value (float,object)
    * @param {GameObject} gameObject:GameObject Gameobject that you wish to attach the tween to
    ...
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    */
		public static AlphaLTDescr value(GameObject gameObject, Action<float, object> callOnUpdate, float from, float to, float time)
		{
			return pushNewTween(gameObject, new Vector3(to, 0, 0), time, AlphaTweenAction.CALLBACK, options().setTo(new Vector3(to, 0, 0)).setFrom(new Vector3(from, 0, 0)).setOnUpdate(callOnUpdate, gameObject));
		}

		public static AlphaLTDescr delayedSound(AudioClip audio, Vector3 pos, float volume)
		{
			//Debug.LogError("Delay sound??");
			return pushNewTween(tweenEmpty, pos, 0f, AlphaTweenAction.DELAYED_SOUND, options().setTo(pos).setFrom(new Vector3(volume, 0, 0)).setAudio(audio));
		}

		public static AlphaLTDescr delayedSound(GameObject gameObject, AudioClip audio, Vector3 pos, float volume)
		{
			//Debug.LogError("Delay sound??");
			return pushNewTween(gameObject, pos, 0f, AlphaTweenAction.DELAYED_SOUND, options().setTo(pos).setFrom(new Vector3(volume, 0, 0)).setAudio(audio));
		}
    ...
    * 
    * @method AlphaTween.move (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {Vector3} to:Vector3 The final Vector3 with which to tween to
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.move(gameObject.GetComponent&lt;RectTransform&gt;(), new Vector3(200f,-100f,0f), 1f).setDelay(1f);
    */
		public static AlphaLTDescr move(RectTransform rectTrans, Vector3 to, float time)
		{
			return pushNewTween(rectTrans.gameObject, to, time, AlphaTweenAction.CANVAS_MOVE, options().setRect(rectTrans));
		}

		/**
    * Move a RectTransform object affecting x-axis only (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.moveX (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The final x location with which to tween to
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.moveX(gameObject.GetComponent&lt;RectTransform&gt;(), 200f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr moveX(RectTransform rectTrans, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_MOVE_X, options().setRect(rectTrans));
		}

		/**
    * Move a RectTransform object affecting y-axis only (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.moveY (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The final y location with which to tween to
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.moveY(gameObject.GetComponent&lt;RectTransform&gt;(), 200f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr moveY(RectTransform rectTrans, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_MOVE_Y, options().setRect(rectTrans));
		}

		/**
    * Move a RectTransform object affecting z-axis only (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.moveZ (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The final x location with which to tween to
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.moveZ(gameObject.GetComponent&lt;RectTransform&gt;(), 200f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr moveZ(RectTransform rectTrans, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_MOVE_Z, options().setRect(rectTrans));
		}

		/**
    * Rotate a RectTransform object (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.rotate (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The degree with which to rotate the RectTransform
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.rotate(gameObject.GetComponent&lt;RectTransform&gt;(), 90f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr rotate(RectTransform rectTrans, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_ROTATEAROUND, options().setRect(rectTrans).setAxis(Vector3.forward));
		}

		/**
    * Rotate a RectTransform object (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.rotateAround (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {Vector3} axis:Vector3 The axis in which to rotate the RectTransform (Vector3.forward is most commonly used)
    * @param {float} to:float The degree with which to rotate the RectTransform
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.rotateAround(gameObject.GetComponent&lt;RectTransform&gt;(), Vector3.forward, 90f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr rotateAround(RectTransform rectTrans, Vector3 axis, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_ROTATEAROUND, options().setRect(rectTrans).setAxis(axis));
		}

		/**
    * Rotate a RectTransform object around it's local axis (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.rotateAroundLocal (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {Vector3} axis:Vector3 The local axis in which to rotate the RectTransform (Vector3.forward is most commonly used)
    * @param {float} to:float The degree with which to rotate the RectTransform
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.rotateAroundLocal(gameObject.GetComponent&lt;RectTransform&gt;(), Vector3.forward, 90f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr rotateAroundLocal(RectTransform rectTrans, Vector3 axis, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_ROTATEAROUND_LOCAL, options().setRect(rectTrans).setAxis(axis));
		}

		/**
    * Rotate a RectTransform object (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.scale (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The final Vector3 with which to tween to (localScale)
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.scale(gameObject.GetComponent&lt;RectTransform&gt;(), gameObject.GetComponent&lt;RectTransform&gt;().localScale*2f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr scale(RectTransform rectTrans, Vector3 to, float time)
		{
			return pushNewTween(rectTrans.gameObject, to, time, AlphaTweenAction.CANVAS_SCALE, options().setRect(rectTrans));
		}

		/**
    * Alpha an Image Component attached to a RectTransform (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)
    * 
    * @method AlphaTween.alpha (RectTransform)
    * @param {RectTransform} rectTrans:RectTransform RectTransform that you wish to attach the tween to
    * @param {float} to:float The final Vector3 with which to tween to (localScale)
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.alpha(gameObject.GetComponent&lt;RectTransform&gt;(), 0.5f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr alpha(RectTransform rectTrans, float to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(to, 0f, 0f), time, AlphaTweenAction.CANVAS_ALPHA, options().setRect(rectTrans));
		}
    ...
    * @param {float} time:float The time to complete the tween in
    * @return {AlphaLTDescr} AlphaLTDescr an object that distinguishes the tween
    * @example AlphaTween.color(gameObject.GetComponent&lt;RectTransform&gt;(), 0.5f, 1f).setDelay(1f);
    */
		public static AlphaLTDescr color(RectTransform rectTrans, Color to, float time)
		{
			return pushNewTween(rectTrans.gameObject, new Vector3(1.0f, to.a, 0.0f), time, AlphaTweenAction.CANVAS_COLOR, options().setRect(rectTrans).setPoint(new Vector3(to.r, to.g, to.b)));
		}

		#endif

		#if AlphaTween_1
		// AlphaTween 1.x Methods

		public static Hashtable h( object[] arr ){
		if(arr.Length%2==1){
		logError("AlphaTween - You have attempted to create a Hashtable with an odd number of values.");
		return null;
		}
		...
		private static int pushNewTween( GameObject gameObject, Vector3 to, float time, AlphaTweenAction AlphaTweenAction, Hashtable optional ){
		init(maxTweens);
		if(gameObject==null)
		return -1;
		...
		j++;
		if(j>=maxTweens){
		logError("AlphaTween - You have run out of available spaces for tweening. To avoid this error increase the number of spaces to available for tweening when you initialize the AlphaTween class ex: AlphaTween.init( "+(maxTweens*2)+" );");
		return -1;
		}
		}
		AlphaLTDescr tween = tweens[i];
		tween.toggle = true;
		tween.reset();
		tween.trans = gameObject.transform;
		tween.to = to;
		...
		if(ease!=null) {
		tween.tweenType = AlphaTweenType.linear;
		if( ease.GetType() ==typeof( AlphaTweenType) ){
		tween.tweenType = (AlphaTweenType)ease;// Enum.Parse(typeof(AlphaTweenType), optional["ease"].ToString());
		...
		tween.tweenType = AlphaTweenType.easeOutQuad;
		}else if(func.Equals("easeInQuad")){
		tween.tweenType = AlphaTweenType.easeInQuad;
		}else if(func.Equals("easeInOutQuad")){
		tween.tweenType = AlphaTweenType.easeInOutQuad;
		}
		}
		optionsNotUsed++;
		}
		if(optional["rect"]!=null){
		tween.AlphaLTRect = (AlphaLTRect)optional["rect"];
		optionsNotUsed++;
		}
		if(optional["path"]!=null){
		tween.path = (AlphaAlphaLTBezierPath)optional["path"];
		optionsNotUsed++;
		}
		...
		tween.loopType = (AlphaTweenType)optional["loopType"];
		optionsNotUsed++;
		}
		if(optional["repeat"]!=null){
		tween.loopCount = (int)optional["repeat"];
		if(tween.loopType==AlphaTweenType.once)
		tween.loopType = AlphaTweenType.clamp;
		optionsNotUsed++;
		}
		...
		int id = idFromUnique( pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.CALLBACK, optional ) );
		...
		optional["onUpdate"] = callOnUpdate;
		int id = idFromUnique( pushNewTween( gameObject, to, time, AlphaTweenAction.VALUE3, optional ) );
		tweens[id].from = from;
		return id;
		}
		...
		return pushNewTween( gameObject, to, time, AlphaTweenAction.ROTATE, optional );
		}
		...
		public static int rotate(AlphaLTRect AlphaLTRect, float to, float time, Hashtable optional){
		init();
		if( optional==null || optional.Count == 0 )
		optional = new Hashtable();

		optional["rect"] = AlphaLTRect;
		return pushNewTween( tweenEmpty, new Vector3(to,0f,0f), time, AlphaTweenAction.GUI_ROTATE, optional );
		}
		public static int rotate(AlphaLTRect AlphaLTRect, float to, float time, object[] optional){
		return rotate( AlphaLTRect, to, time, h(optional) );
		}
		public static int rotateX(GameObject gameObject, float to, float time, Hashtable optional){
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.ROTATE_X, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.ROTATE_Y, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.ROTATE_Z, optional );
		}
		...
		return pushNewTween( gameObject, to, time, AlphaTweenAction.ROTATE_LOCAL, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(add,0f,0f), time, AlphaTweenAction.ROTATE_AROUND, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_X, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_Y, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_Z, optional );
		}
		...
		return pushNewTween( gameObject, to, time, AlphaTweenAction.MOVE, optional );
		}
		public static int move(GameObject gameObject, Vector3 to, float time, object[] optional){
		return move( gameObject, to, time, AlphaTween.h( optional ) );
		}
		public static int move(GameObject gameObject, Vector3[] to, float time, Hashtable optional){
		if(to.Length<4){
		string errorMsg = "AlphaTween - When passing values for a vector path, you must pass four or more values!";
		if(throwErrors) Debug.LogError(errorMsg); else Debug.Log(errorMsg);
		return -1;
		}
		if(to.Length%4!=0){
		string errorMsg2 = "AlphaTween - When passing values for a vector path, they must be in sets of four: controlPoint1, controlPoint2, endPoint2, controlPoint2, controlPoint2...";
		...
		AlphaAlphaLTBezierPath ltPath = new AlphaAlphaLTBezierPath( to );
		if(optional["orientToPath"]!=null)
		ltPath.orientToPath = true;
		optional["path"] = ltPath;

		return pushNewTween( gameObject, new Vector3(1.0f,0.0f,0.0f), time, AlphaTweenAction.MOVE_CURVED, optional );
		}
		public static int move(GameObject gameObject, Vector3[] to, float time, object[] optional){
		return move( gameObject, to, time, AlphaTween.h( optional ) );
		}

		public static int move(AlphaLTRect AlphaLTRect, Vector2 to, float time, Hashtable optional){
		init();
		if( optional==null || optional.Count == 0 )
		optional = new Hashtable();

		optional["rect"] = AlphaLTRect;
		return pushNewTween( tweenEmpty, to, time, AlphaTweenAction.GUI_MOVE, optional );
		}
		public static int move(AlphaLTRect AlphaLTRect, Vector3 to, float time, object[] optional){
		return move( AlphaLTRect, to, time, AlphaTween.h( optional ) );
		}

		public static int moveLocal(GameObject gameObject, Vector3 to, float time, Hashtable optional){
		return pushNewTween( gameObject, to, time, AlphaTweenAction.MOVE_LOCAL, optional );
		}
		public static int moveLocal(GameObject gameObject, Vector3 to, float time, object[] optional){
		return moveLocal( gameObject, to, time, AlphaTween.h( optional ) );
		}
		...
		return pushNewTween( gameObject, new Vector3(1.0f,0.0f,0.0f), time, AlphaTweenAction.MOVE_CURVED_LOCAL, optional );
		}
		public static int moveLocal(GameObject gameObject, Vector3[] to, float time,object[] optional){
		return moveLocal( gameObject, to, time, AlphaTween.h( optional ) );
		}
		public static int moveLocalX(GameObject gameObject, float to, float time, Hashtable optional){
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_LOCAL_X, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_LOCAL_Y, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.MOVE_LOCAL_Z, optional );
		}
		...
		return pushNewTween( gameObject, to, time, AlphaTweenAction.SCALE, optional );
		}
		...
		public static int scale(AlphaLTRect AlphaLTRect,Vector2 to, float time, Hashtable optional)
		{ 
		init();
		if( optional==null || optional.Count == 0 )
		optional = new Hashtable();
		...
		optional["rect"] = AlphaLTRect;
		return pushNewTween( tweenEmpty, to, time, AlphaTweenAction.GUI_SCALE, optional );
		}
		public static int scale(AlphaLTRect AlphaLTRect, Vector2 to, float time, object[] optional){
		return scale( AlphaLTRect, to, time, h(optional) );
		}
		public static int alpha(AlphaLTRect AlphaLTRect, float to, float time, Hashtable optional){
		init();
		if( optional==null || optional.Count == 0 )
		optional = new Hashtable();
		...
		AlphaLTRect.alphaEnabled = true;
		optional["rect"] = AlphaLTRect;
		return pushNewTween( tweenEmpty, new Vector3(to,0f,0f), time, AlphaTweenAction.GUI_ALPHA, optional );
		}
		public static int alpha(AlphaLTRect AlphaLTRect, float to, float time, object[] optional){
		return alpha( AlphaLTRect, to, time, h(optional) );
		}
		public static int scaleX(GameObject gameObject, float to, float time, Hashtable optional){
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.SCALE_X, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.SCALE_Y, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.SCALE_Z, optional );
		}
		...
		return pushNewTween( gameObject, Vector3.zero, delayTime, AlphaTweenAction.CALLBACK, optional );
		}
		...
		return pushNewTween( gameObject, new Vector3(to,0,0), time, AlphaTweenAction.ALPHA, optional );
		}
		...
		private static float tweenOnCurve(AlphaLTDescr tweenDescr, float ratioPassed)
		{
		...
		private static Vector3 tweenOnCurveVector(AlphaLTDescr tweenDescr, float ratioPassed)
		{
		...
		// AlphaTween Listening/Dispatch

		private static System.Action<AlphaLTEvent>[] eventListeners;
		...
		public static void addListener(int eventId, System.Action<AlphaLTEvent> callback)
		{
			addListener(tweenEmpty, eventId, callback);
		}

		/**
    * Add a listener method to be called when the appropriate AlphaTween.dispatchEvent is called
    *
    * @method AlphaTween.addListener
    ...
    * @param {System.Action<AlphaLTEvent>} callback:System.Action<AlphaLTEvent> the method to call when the event has been dispatched
    * @example
    * AlphaTween.addListener(gameObject, (int)MyEvents.JUMP, jumpUp);<br>
    * <br>
    * void jumpUp( AlphaLTEvent e ){ Debug.Log("jump!"); }<br>
    */
		public static void addListener(GameObject caller, int eventId, System.Action<AlphaLTEvent> callback)
		{
			if (eventListeners == null)
			{
				INIT_LISTENERS_MAX = LISTENERS_MAX;
				eventListeners = new System.Action<AlphaLTEvent>[EVENTS_MAX * LISTENERS_MAX];
			...
			Debug.LogError("You ran out of areas to add listeners, consider increasing INIT_LISTENERS_MAX, ex: AlphaTween.INIT_LISTENERS_MAX = " + (INIT_LISTENERS_MAX * 2));
		}

		public static bool removeListener(int eventId, System.Action<AlphaLTEvent> callback)
		{
    ...
    * @method AlphaTween.removeListener
    * @param {GameObject} caller:GameObject the gameObject the listener is attached to
    * @param {int} eventId:int a unique int that describes the event (best to use an enum)
    * @param {System.Action<AlphaLTEvent>} callback:System.Action<AlphaLTEvent> the method that was specified to call when the event has been dispatched
    * @example
    * AlphaTween.removeListener(gameObject, (int)MyEvents.JUMP, jumpUp);<br>
    * <br>
    * void jumpUp( AlphaLTEvent e ){ }<br>
    */
		public static bool removeListener(GameObject caller, int eventId, System.Action<AlphaLTEvent> callback)
		{
    ...
    * @method AlphaTween.dispatchEvent
    * @param {int} eventId:int a unique int that describes the event (best to use an enum)
    * @example
    * AlphaTween.dispatchEvent( (int)MyEvents.JUMP );<br>
    */
    ...
    * @method AlphaTween.dispatchEvent
    * @param {int} eventId:int a unique int that describes the event (best to use an enum)
    * @param {object} data:object Pass data to the listener, access it from the listener with *.data on the AlphaLTEvent object
    * @example
    * AlphaTween.dispatchEvent( (int)MyEvents.JUMP, transform );<br>
    * <br>
    * void jumpUp( AlphaLTEvent e ){<br>
    ...
    */
		public static void dispatchEvent(int eventId, object data)
		{
			for (int k = 0; k < eventsMaxSearch; k++)
			{
				...
				if (eventListeners[point] != null)
				{
					...
					{
						eventListeners[point](new AlphaLTEvent(eventId, data));
					}
					else {
						eventListeners[point] = null;
					}
	...
	} // End AlphaTween class

	public class AlphaLTBezier
	{
		public float length;
		...
		public AlphaLTBezier(Vector3 a, Vector3 b, Vector3 c, Vector3 d, float precision)
		{
			this.a = a;
			aa = (-a + 3 * (b - c) + d);
			bb = 3 * (a + c) - 6 * b;
...
* @example 
* AlphaAlphaLTBezierPath ltPath = new AlphaAlphaLTBezierPath( new Vector3[] { new Vector3(0f,0f,0f),new Vector3(1f,0f,0f), new Vector3(1f,0f,0f), new Vector3(1f,1f,0f)} );<br><br>
* AlphaTween.move(lt, ltPath.vec3, 4.0f).setOrientToPath(true).setDelay(1f).setEase(AlphaTweenType.easeInOutQuad); // animate <br>
* Vector3 pt = ltPath.point( 0.6f ); // retrieve a point along the path
*/
	public class AlphaAlphaLTBezierPath
	{
		public Vector3[] pts;
		public float length;
		...
		private AlphaLTBezier[] beziers;
		private float[] lengthRatio;
		private int currentBezier = 0, previousBezier = 0;

		public AlphaAlphaLTBezierPath() { }
		public AlphaAlphaLTBezierPath(Vector3[] pts_)
		{
			setPoints(pts_);
		}
		...
		{
			if (pts_.Length < 4)
				PTAlphaTween.logError("AlphaTween - When passing values for a vector path, you must pass four or more values!");
			if (pts_.Length % 4 != 0)
				PTAlphaTween.logError("AlphaTween - When passing values for a vector path, they must be in sets of four: controlPoint1, controlPoint2, endPoint2, controlPoint2, controlPoint2...");

			pts = pts_;

			int k = 0;
			beziers = new AlphaLTBezier[pts.Length / 4];
			lengthRatio = new float[beziers.Length];
			int i;
			length = 0;
			for (i = 0; i < pts.Length; i += 4)
			{
				beziers[k] = new AlphaLTBezier(pts[i + 0], pts[i + 2], pts[i + 1], pts[i + 3], 0.05f);
...
* @example 
* AlphaLTSpline AlphaLTSpline = new AlphaLTSpline( new Vector3[] { new Vector3(0f,0f,0f),new Vector3(0f,0f,0f), new Vector3(0f,0.5f,0f), new Vector3(1f,1f,0f), new Vector3(1f,1f,0f)} );<br><br>
* AlphaTween.moveSpline(lt, AlphaLTSpline.vec3, 4.0f).setOrientToPath(true).setDelay(1f).setEase(AlphaTweenType.easeInOutQuad); // animate <br>
* Vector3 pt = AlphaLTSpline.point( 0.6f ); // retrieve a point along the path
*/
	[System.Serializable]
	public class AlphaLTSpline
	{
		...
		public AlphaLTSpline(params Vector3[] pts)
		{
    ...
    * @return {Vector3} Vector3 position of the point along the path
    * @example
    * transform.position = AlphaLTSpline.point( 0.6f );
    */
		public Vector3 point(float ratio)
		{
...
* <strong>Example Javascript: </strong><br>var bRect:AlphaLTRect = new AlphaLTRect( 0, 0, 100, 50 );<br>
* AlphaTween.scale( bRect, Vector2(bRect.rect.width, bRect.rect.height) * 1.3, 0.25 );<br>
* function OnGUI(){<br>
* &nbsp; if(GUI.Button(bRect.rect, "Scale")){ }<br>
* }<br>
* <br>
...
* AlphaLTRect bRect = new AlphaLTRect( 0f, 0f, 100f, 50f );<br>
* AlphaTween.scale( bRect, new Vector2(150f,75f), 0.25f );<br>
* void OnGUI(){<br>
* &nbsp; if(GUI.Button(bRect.rect, "Scale")){ }<br>
* }<br>
*
...
*/
	...
	[System.Serializable]
	public class AlphaLTRect : System.Object
	{
		/**
    ...
    */
		...
		public AlphaLTGUI.Element_Type type;
		...
		public AlphaLTRect(Rect rect)
		{
			_rect = rect;
			reset();
		}

		public AlphaLTRect(float x, float y, float width, float height)
		{
		...
		public AlphaLTRect(float x, float y, float width, float height, float alpha)
		{
			_rect = new Rect(x, y, width, height);
			this.alpha = alpha;
			this.rotation = 0.0f;
		...
		public AlphaLTRect(float x, float y, float width, float height, float alpha, float rotation)
		{
			_rect = new Rect(x, y, width, height);
			this.alpha = alpha;
		...
		public AlphaLTRect setStyle(GUIStyle style)
		{
			this.style = style;
			return this;
		}

		public AlphaLTRect setFontScaleToFit(bool fontScaleToFit)
		{
			this.fontScaleToFit = fontScaleToFit;
			return this;
		}

		public AlphaLTRect setColor(Color color)
		{
			this.color = color;
			this.useColor = true;
			return this;
		...
		public AlphaLTRect setAlpha(float alpha)
		{
			this.alpha = alpha;
			return this;
		}

		public AlphaLTRect setLabel(String str)
		{
			this.labelStr = str;
			return this;
		}

		public AlphaLTRect setUseSimpleScale(bool useSimpleScale, Rect relativeRect)
		{
		...
		public AlphaLTRect setUseSimpleScale(bool useSimpleScale)
		{
			this.useSimpleScale = useSimpleScale;
		...
		public AlphaLTRect setSizeByHeight(bool sizeByHeight)
		{
...
*/
	public class AlphaLTEvent
	{
		public int id;
		public object data;

		public AlphaLTEvent(int id, object data)
		{
			this.id = id;
			this.data = data;
		}
	...
	public class AlphaLTGUI
	{
		...
		public static void init()
		{
			if (levels == null)
			{
				levels = new AlphaLTRect[RECT_LEVELS * RECTS_PER_LEVEL];
		...
		public static AlphaLTRect label(Rect rect, string label, int depth)
		{
			return AlphaLTGUI.label(new AlphaLTRect(rect), label, depth);
		}

		public static AlphaLTRect label(AlphaLTRect rect, string label, int depth)
		{
		...
		public static AlphaLTRect texture(Rect rect, Texture texture, int depth)
		{
			return AlphaLTGUI.texture(new AlphaLTRect(rect), texture, depth);
		}

		public static AlphaLTRect texture(AlphaLTRect rect, Texture texture, int depth)
		{
		...
		public static AlphaLTRect element(AlphaLTRect rect, int depth)
		{
			isGUIEnabled = true;
			init();
			int maxLoop = depth * RECTS_PER_LEVEL + RECTS_PER_LEVEL;
			...
			if (rect.type == AlphaLTGUI.Element_Type.Label && rect.style != null)
			{
