...
#region 通用功能接口
        ...
        {
            QEventSystem.Instance.Send(key, args);
        }
        ...
        public void RegisterEvent<K>(K key, OnEvent callback) where K : IConvertible
        {
            ...
            {
                m_EventRegisterHelper = ObjectPool<EventRegisterHelper>.Instance.Allocate();
                m_EventRegisterHelper.eventSystem = QEventSystem.Instance;
            }
        ...
        public void UnRegisterAllEvent()
        {
            ...
            ObjectPool<EventRegisterHelper>.Instance.Recycle(m_EventRegisterHelper);
